...
try:
    ...
    generators.add_metadata_from_file(model_id=model_id, metadata_file_path=metadata_file_path)
    ...
    # Zenodo upload test
    generators.push_to_zenodo(model_id=model_id, access_token=access_token, creator_name="test", creator_affiliation="test affiliation")
