...
| <sub> Cardiac MRI Age Transfer </sub> | <sub>  cardiac MRI  </sub> | <sub>   wgan      </sub> | <sub>256x256  </sub> | <sub>    [UK Biobank](https://www.ukbiobank.ac.uk/)     </sub> | ![sample](docs/source/_static/samples/00022.png) | <sub> `00022_WGAN_CARDIAC_AGING` </sub> | <sub>[Zenodo (7446930)](https://doi.org/10.5281/zenodo.74469305) </sub> | <sub> [Campello et al (2022)](https://doi.org/10.3389/fcvm.2022.983091) </sub> |
